...
const weeks = [
  ...
  },
  {
    ...
    description:
      "Master the art of communicating with LLMs to craft reliable, high-quality outputs for real tasks.",
  ...
  },
  {
    ...
    title: "AI Research",
    description:
      "Use AI to accelerate learning, synthesize complex topics, and dive into research in depth.",
  ...
  },
  {
    ...
    description:
      "Generate, iterate, and polish written and visual content with AI as your collaborative partner.",
  ...
  },
  {
    ...
    description:
      "Email, planning, notes, scheduling — build a personal system that saves hours weekly.",
  ...
  },
  {
    ...
    title: "AI Automation",
    description:
      "Connect tools, automate repetitive tasks, and build small workflows that run for you.",
  ...
  },
  {
    ...
    title: "Projects",
    description:
      "Pick a real problem — academic, personal, or professional — and build a solution end-to-end.",
  ...
  },
  {
    ...
    description:
      "Demo your project, get feedback, and ship it into real use — portfolio, campus, or workplace.",
      ...
      <div className="container-x relative z-10">
        ...
        <div className="flex flex-col items-center text-center gap-8 mb-16">
          <div className="max-w-3xl mx-auto flex flex-col items-center">
            ...
            <p className="text-lg md:text-xl text-ink-soft leading-relaxed max-w-xl mx-auto">
              A comprehensive hands-on AI program designed to help students become AI-ready with
              practical skills they can immediately apply in academics, careers, freelancing,
              entrepreneurship, and daily productivity.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center gap-3 shrink-0">
            <div className="text-sm font-mono text-ink-soft uppercase tracking-wider flex items-center justify-center gap-2">
              ...
              <span className="w-1 h-1 rounded-full bg-ink-soft"></span>
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <Button
                size="lg"
                className="bg-orange-600 hover:bg-orange-700 text-white rounded-md px-8"
                asChild
              >
                <Link to="/programs/ai-upskilling">Apply now</Link>
              </Button>
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex justify-between items-start mb-12">
                ...
                {week.badge ? (
                  ...
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center ${week.iconBg} transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3`}
                  >
                    {week.icon}
                  </div>
                )}
              ...
              <div className="flex-1">
                ...
                <p className="text-ink-soft text-sm leading-relaxed mb-12">{week.description}</p>
              </div>

              {/* Card Footer */}
              <div className="mt-auto pt-4 border-t border-border/30">
                <p className="text-xs font-mono text-ink-soft/70">{week.tags}</p>
              </div>
        ...
        <div className="mt-12 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pt-8 border-t border-border/40">
          <div className="flex items-center gap-2 text-sm text-ink-soft">
            <span className="flex items-center justify-center w-5 h-5 rounded-full border border-ink-soft/50 text-[10px]">
              i
            </span>
            <p>
              The 8-week program is one of IndiaFutureAI's flagship student offerings — explore
              masterclasses and corporate tracks above.
            </p>
          </div>

          <Link
            to="/programs/ai-upskilling"
            className="text-sm font-medium text-ink flex items-center gap-2 hover:text-orange-600 transition-colors group"
          >
            See all programs
