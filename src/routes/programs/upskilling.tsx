...
export const Route = createFileRoute("/programs/upskilling")({
  component: UpskillingProgram,
});

function UpskillingProgram() {
  return (
        ...
        <div className="container-x relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <p className="text-xs uppercase tracking-[0.2em] text-brand font-semibold mb-4">Upskilling</p>
              
              <h1 className="font-display text-5xl md:text-6xl lg:text-[4.5rem] leading-[1.05] text-ink tracking-tight mb-8">
                AI Upskilling <br className="hidden md:block" />
                <span className="italic text-brand-soft">Programs</span>
              </h1>
              
              <p className="text-ink-soft text-xl leading-relaxed mb-10 max-w-lg">
                A comprehensive hands-on AI program designed to help students become AI-ready with practical skills.
              </p>
