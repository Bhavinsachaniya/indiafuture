      ...
      <div className="container-x mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="font-display text-5xl md:text-6xl lg:text-7xl leading-[1.05] text-[#161413] mb-6">
            Frequently Asked<span className="text-[#f97316]">.</span>
          </h2>
        ...
        <div className="mt-16 flex flex-col items-center justify-center gap-4 text-center">
          ...
          <Link to="/contact" className="text-[#f97316] font-bold flex items-center gap-2 hover:opacity-80 transition-opacity">
