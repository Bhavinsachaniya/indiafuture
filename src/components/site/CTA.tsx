      ...
      <div className="container-x mx-auto">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-[#161413] text-white px-6 md:px-12 py-16 md:py-20 text-center shadow-xl">
          ...
          <div className="absolute bottom-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
             <svg viewBox="0 0 1000 600" className="absolute -bottom-[20%] -left-[10%] w-[50%] h-[100%] opacity-[0.15]">
             ...
             <svg viewBox="0 0 1000 600" className="absolute -bottom-[20%] -right-[10%] w-[50%] h-[100%] opacity-[0.15]">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-6 text-white/70 max-w-xl mx-auto text-lg md:text-xl font-light">
              Cohort-based programs. Practical learning.<br className="hidden md:block" />
            ...
            <Link to="/contact" className="inline-flex items-center gap-3 rounded-full bg-white text-[#161413] px-8 py-4 text-base font-bold hover:bg-[#f9f8f6] transition-colors shadow-lg">
