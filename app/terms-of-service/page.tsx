...
const sections = [
  {
    ...
    content: (
      <p>
        IndiaFutureAI provides AI learning programs, workshops, implementation services,
        institutional partnerships, AI labs, and related educational services.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        You must be legally capable of entering into binding agreements or have appropriate parental
        or institutional permission where applicable.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        You agree to provide accurate information during registration and keep your details updated.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Certain programs require payment. Fees, refunds, and payment schedules will be communicated
        during registration.
      </p>
    ),
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">
          All content including course materials, videos, slides, documents, frameworks, designs,
          branding, and website content remain the intellectual property of IndiaFutureAI unless
          otherwise stated.
        </p>
        <p>
          No material may be copied, redistributed, recorded, resold, or commercially used without
          written permission.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    content: (
      <p>
        Certificates may be issued only upon successful completion of eligible programs and
        fulfillment of participation requirements.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Programs may include access to third-party AI platforms. IndiaFutureAI is not responsible
        for changes, outages, or policies of these external services.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        While we strive to provide high-quality learning experiences, IndiaFutureAI does not
        guarantee employment, internships, freelance opportunities, business outcomes, or specific
        results.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        We reserve the right to suspend or terminate access in cases of misuse, policy violations,
        or unlawful conduct.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        Programs, schedules, instructors, and content may evolve over time to improve the learning
        experience.
      </p>
    ),
  },
  {
    ...
    content: (
      <p>
        ...
        jurisdiction of the competent courts of Gurugram, Haryana.
      </p>
    ),
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Email: <strong>hello@indiafutureai.com</strong>
        </p>
      </>
    ),
  },
        ...
        <section className="container-x mx-auto max-w-5xl px-6 mb-16 text-center">
          <div className="border-b border-[#161413]/10 pb-12">
            ...
            <p className="text-[#161413]/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              By accessing or using IndiaFutureAI&apos;s website, programs, workshops, and services,
                  ...
                  <li key={sec.id} className="relative">
                    ...
                    <button
                      ...
                      className={`text-left text-sm font-semibold transition-colors duration-200 focus:outline-none flex gap-2 w-full ${
                        isActive ? "text-[#f97316]" : "text-[#161413]/50 hover:text-[#161413]"
                      }`}
                    >
                      <span>{numStr}.</span>
                      <span>{sec.title}</span>
