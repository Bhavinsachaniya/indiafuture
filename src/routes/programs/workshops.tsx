        ...
        <div className="container-x relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <p className="text-xs uppercase tracking-[0.2em] text-brand font-semibold mb-4">Workshops</p>
              
              <h1 className="font-display text-5xl md:text-6xl lg:text-[4.5rem] leading-[1.05] text-ink tracking-tight mb-8">
                Hands-on Automation <br className="hidden md:block" />
                <span className="italic text-brand-soft">Labs</span>
              </h1>
              
              <p className="text-ink-soft text-xl leading-relaxed mb-10 max-w-lg">
                AI Labs and productivity training for educators and teams to automate repetitive tasks and build workflows.
              </p>
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col gap-6">
                  {[
                    ...
                    "Zapier & Make.com Masterclass",
                    "Automating Invoicing & Lead Capture",
                    "Building Internal Knowledge Bases",
                    "Saving 10+ Hours/Week with AI"
                  ].map((item, idx) => (
