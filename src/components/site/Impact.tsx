          ...
          <div className="lg:col-span-7 flex flex-col gap-12 md:gap-24 pb-12">
            ...
            <div className="bg-[#161413] border border-cream/10 rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden group hover:border-brand/30 transition-colors duration-500">
              ...
              <div className="grid sm:grid-cols-2 gap-10 relative z-10 mt-8">
                <div>
                  ...
                  <p className="text-cream/60 leading-relaxed">Employees automate repetitive tasks to focus purely on high-value creative problem solving and strategy.</p>
                </div>
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    <span className="font-display text-6xl text-brand">100X</span>
            ...
            <div className="bg-[#161413] border border-cream/10 rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden group hover:border-brand/30 transition-colors duration-500">
              ...
              <div className="flex items-center gap-4 mb-10 relative z-10">
                ...
                <h3 className="font-display text-3xl md:text-4xl text-cream">Organizational Growth</h3>
              </div>
              ...
              <div className="grid gap-10 relative z-10 mt-8">
                <div className="border-l-2 border-brand pl-6">
                  ...
                  <p className="text-cream/60 text-lg leading-relaxed">Scale operations infinitely without scaling headcount. Serve millions of customers with the overhead of a startup.</p>
                </div>
