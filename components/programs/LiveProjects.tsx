          ...
          {data.projects.map((project, idx) => (
            ...
            >
              ...
              <div className="relative z-10 flex-grow">
                ...
                <p className="text-cream/70 text-lg leading-relaxed mb-8">{project.previewText}</p>

                <div className="space-y-6 mt-auto">
                  <div>
                    <p className="text-xs uppercase tracking-widest text-cream/40 mb-3">
                      Tech Stack
                    </p>
                  ...
                  <div className="pt-6 border-t border-white/10 flex flex-col sm:flex-row gap-6">
                    ...
                    <div>
                      <p className="text-xs uppercase tracking-widest text-cream/40 mb-2">
                        Duration
                      </p>
