...
const baseItems = [
  { q: "IndiaFutureAI is the only program I've been in where you walk out with practical skills, not just notes.", n: "Priya Ramesh", r: "Student, CS", img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=80&h=80&fit=crop&crop=faces" },
  { q: "The weekly assignments changed how our whole team thinks about productivity. Worth every rupee.", n: "Marcus Weller", r: "Head of AI, SaaS scale-up", img: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80&h=80&fit=crop&crop=faces" },
  { q: "I went from 'exploring LLMs' to shipping automations that save my ops team 20 hours a week.", n: "Ananya Kapoor", r: "Founder, ops platform", img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=80&h=80&fit=crop&crop=faces" },
  { q: "Their approach to practical AI implementation is unparalleled. My students learned more in 8 weeks than in 2 years of traditional study.", n: "Sarah Jenkins", r: "Professor & Educator", img: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=80&h=80&fit=crop&crop=faces" },
];
    ...
    <section className="py-28 bg-surface overflow-hidden">
      <div className="container-x">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xs uppercase tracking-[0.2em] text-brand">Voices from our programs</p>
