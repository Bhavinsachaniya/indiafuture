...
export const programsConfig: Record<string, ProgramData> = {
  upskilling: {
    ...
    curriculum: [
      { week: "Week 1", title: "Foundations", description: "Introduction to generative models and core concepts." },
      { week: "Week 2", title: "Prompt Engineering", description: "Advanced techniques for steering LLMs." },
      { week: "Week 3", title: "Automation", description: "Building no-code and low-code workflows." },
      { week: "Week 4", title: "AI Agents", description: "Creating autonomous agents to perform complex tasks." },
      { week: "Week 5", title: "Projects", description: "Building your comprehensive capstone project." },
      { week: "Week 6", title: "Deployment & Certification", description: "Deploying to production and finalizing certification." },
    ],
    projects: [
      {
        title: "Personal AI Assistant",
        previewText: "Build a context-aware assistant that remembers past conversations and connects to calendar APIs.",
      ...
      },
      {
        ...
        previewText: "Design a workflow that researches, drafts, and schedules social media content automatically.",
    ...
    outcomes: [
      ...
      { phase: "During Learning", description: "Building muscle memory through daily hands-on projects and workflows." },
      { phase: "After Completion", description: "Confident AI builder with a portfolio of live, deployed applications." },
      { phase: "Career Growth", description: "Ready for AI Engineering roles with verified certification." },
    ],
    testimonials: [
      {
        quote: "This program transformed how I approach software engineering. I went from reading papers to building actual AI agents in weeks.",
        author: "Sarah Chen",
      ...
      {
        quote: "The hands-on projects were incredible. I used my capstone project to land my first junior developer role.",
        author: "James Miller",
    ...
    faqs: [
      { question: "Do I need prior coding experience?", answer: "Basic programming knowledge is helpful but not strictly required. We cover foundations early on." },
      { question: "How much time is required?", answer: "Expect to dedicate 8-10 hours per week for lectures and assignments." },
      { question: "Is the certification recognized?", answer: "Yes, our certificates are verified and highly regarded by our hiring partners." }
    ]
  },
  ...
  masterclasses: {
    ...
    learnings: [
      ...
      },
      {
        ...
        description: "Strategic implementation of AI tools to reduce overhead and increase margins.",
        icon: BarChart,
        duration: "2 Days",
        difficulty: "Intermediate",
      },
      {
        title: "AI for Design",
        description: "Supercharging creative workflows with Midjourney, Stable Diffusion, and Figma AI.",
        icon: Layers,
        duration: "1 Day",
        difficulty: "Intermediate",
      },
    ...
    curriculum: [
      { week: "Session 1", title: "Introduction & Context", description: "Understanding the current AI landscape and capabilities." },
      { week: "Session 2", title: "Prompt Architecture", description: "Building robust, repeatable prompts for professional use." },
      { week: "Session 3", title: "Workflow Integration", description: "Connecting AI outputs directly into your existing tools." },
      { week: "Session 4", title: "Live Assessment", description: "Real-time project build and certification review." },
    ],
    projects: [
      {
        title: "Automated Reporting System",
        previewText: "Convert raw spreadsheet data into polished, executive-ready presentations instantly.",
    ...
    experiences: [
      { title: "Interactive Sessions", description: "Follow along live as instructors build workflows in real-time.", icon: Presentation },
      { title: "Micro-learning", description: "Dense, highly focused modules designed for maximum retention.", icon: Zap },
      { title: "Completion Badges", description: "Shareable credentials for your LinkedIn profile.", icon: ShieldCheck },
    ],
    outcomes: [
      { phase: "Before Joining", description: "Overwhelmed by AI noise, unsure where to start." },
      { phase: "During Learning", description: "Rapid 'Aha!' moments as concepts click into place." },
    ...
    testimonials: [
      {
        quote: "The best 4 hours I've spent this year. I immediately saved our marketing team 15 hours a week.",
        author: "Marcus Doe",
    ...
    faqs: [
      { question: "Are these live or pre-recorded?", answer: "These are highly interactive, live sessions with Q&A." },
      { question: "Will I get a recording?", answer: "Yes, all attendees receive lifetime access to the session recordings." }
    ]
  },
  ...
  workshops: {
    ...
    curriculum: [
      { week: "Module 1", title: "Platform Fundamentals", description: "Navigating triggers, actions, and data mapping." },
      { week: "Module 2", title: "API Connections", description: "Authenticating and writing custom webhooks." },
      { week: "Module 3", title: "Logic & Routing", description: "Building complex conditional pathways." },
      { week: "Module 4", title: "AI Integration", description: "Adding LLMs to process unstructured data." },
      { week: "Module 5", title: "Error Handling", description: "Building resilient systems that don't break." },
      { week: "Module 6", title: "Live Deployment", description: "Publishing your workflows to production." },
    ],
    projects: [
      {
        title: "Intelligent Lead Qualifier",
        previewText: "Automatically score inbound leads using AI and route them to the correct sales rep.",
    ...
    experiences: [
      { title: "Workflow Diagrams", description: "Learn to visually architect systems before you build.", icon: Layers },
      { title: "API Blocks", description: "Demystify complex API documentation.", icon: Code },
      { title: "Real Projects", description: "Build automations that solve your actual business problems.", icon: Settings },
    ],
    outcomes: [
      { phase: "Before Joining", description: "Drowning in manual spreadsheets and data entry." },
      { phase: "During Learning", description: "Connecting systems that previously didn't speak to each other." },
      { phase: "After Completion", description: "Reclaimed 10+ hours per week of deep work time." },
      { phase: "Career Growth", description: "Transition to Systems Architect or Operations Leader." },
    ],
    testimonials: [
      {
        quote: "We automated our entire onboarding process. It feels like we hired three new employees.",
    ...
    faqs: [
      { question: "Do I need to know how to code?", answer: "No, we focus primarily on low-code and no-code tools." },
      { question: "What tools do I need?", answer: "A free Zapier or Make.com account is enough to start." }
    ]
  },
  ...
  custom: {
    ...
    curriculum: [
      { week: "Phase 1", title: "Discovery", description: "Auditing your current systems and identifying AI opportunities." },
      { week: "Phase 2", title: "Curriculum Design", description: "Architecting a custom learning path for your teams." },
      { week: "Phase 3", title: "Executive Alignment", description: "Ensuring leadership understands the ROI and security implications." },
      { week: "Phase 4", title: "Training Execution", description: "Delivering the custom workshops and labs." },
      { week: "Phase 5", title: "Deployment Support", description: "Assisting internal engineers with live implementation." },
      { week: "Phase 6", title: "Review & Scaling", description: "Measuring ROI and expanding across departments." },
    ],
    projects: [
      {
        title: "Internal Knowledge Base Bot",
        previewText: "Train a secure, private LLM on your company's proprietary documents to answer employee questions instantly.",
    ...
    experiences: [
      { title: "Enterprise Dashboard", description: "Track your team's learning progress and ROI.", icon: LineChart },
      { title: "Security First", description: "All implementations prioritize data privacy and SOC2 compliance.", icon: Lock },
      { title: "Dedicated Support", description: "Direct access to our senior AI architects.", icon: Users },
    ],
    outcomes: [
      { phase: "Before Joining", description: "Lagging behind competitors, risking disruption." },
      { phase: "During Learning", description: "Aligning teams around a unified, secure AI strategy." },
      { phase: "After Completion", description: "Deployed custom AI solutions driving massive ROI." },
      { phase: "Career Growth", description: "Positioning the organization as an industry tech leader." },
    ],
    testimonials: [
      {
        quote: "They completely demystified AI for our board and helped us deploy a secure internal tool that saves us millions annually.",
        author: "David Chen",
        role: "CTO",
    ...
    faqs: [
      { question: "Is our data secure?", answer: "Yes, we prioritize zero-retention policies and local deployment models." },
      { question: "Can you train our non-technical staff?", answer: "Absolutely. We design specific tracks for both technical and non-technical teams." }
    ]
  },
};
