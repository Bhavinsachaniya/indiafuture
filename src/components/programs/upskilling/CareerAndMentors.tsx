...
export function CareerAndMentors() {
  const roles = [
    { title: "AI Productivity Specialist", salary: "$70k - $120k", skills: "Workflow Automation, Prompt Engineering" },
    { title: "AI Consultant", salary: "$90k - $150k", skills: "Business Strategy, LLM Implementation" },
    { title: "Automation Operations", salary: "$80k - $130k", skills: "Make.com, Zapier, API Architecture" },
    { title: "Content Strategist (AI)", salary: "$65k - $110k", skills: "Claude, Midjourney, Pipeline Design" },
  ];
        ...
        <div className="container-x">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            ...
            <p className="text-xs uppercase tracking-[0.2em] text-brand font-semibold flex items-center justify-center gap-4">
              <span className="w-12 h-[1px] bg-brand/40" /> THE ROI <span className="w-12 h-[1px] bg-brand/40" />
            </p>
          </div>
            ...
            {roles.map((role, idx) => (
              ...
              >
                ...
                <div className="mt-auto pt-6 border-t border-ink/5">
                  <p className="text-xs uppercase tracking-widest text-ink-soft mb-2 font-semibold">Key Skills</p>
      ...
      <section className="py-24 md:py-32 bg-surface relative overflow-hidden">
        <div className="container-x">
          <div className="max-w-3xl mx-auto mb-20 text-center">
            <div className="flex items-center justify-center gap-4 mb-6">
            <p className="text-xs uppercase tracking-[0.2em] text-brand font-semibold flex items-center justify-center gap-4">
              <span className="w-12 h-[1px] bg-brand/40" /> LEARN FROM THE BEST <span className="w-12 h-[1px] bg-brand/40" />
            </p>
          </div>
