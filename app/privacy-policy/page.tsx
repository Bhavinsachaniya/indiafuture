...
const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">
          We use reasonable administrative, technical, and organizational measures to safeguard your
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Requests may be sent to: <strong>hello@indiafutureai.com</strong>
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          Our services are intended for individuals aged 13 years and above. Users below the
          applicable legal age should participate only with appropriate parental or institutional
          consent.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>
          We may update this Privacy Policy periodically. Changes become effective upon publication
          on this page.
        </p>
      </>
    ),
        ...
        <section className="container-x mx-auto max-w-5xl px-6 mb-16 text-center">
          <div className="border-b border-[#161413]/10 pb-12">
            ...
            <p className="text-[#161413]/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
              Your privacy is important to us. This Privacy Policy explains how IndiaFutureAI
              collects, uses, stores, and protects your information when you visit our website,
