...
import { ArrowRight, Download, Calendar, Clock, MonitorPlay, Users, Award, BookOpen } from "lucide-react";
        ...
        <div className="container-x relative z-10">
          <div className="grid lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              >
                Stop reading about AI and start building with it. Master Prompt Engineering, Automation Workflows, and Custom Agents in an intensive 8-week bootcamp.
              </motion.p>
              ...
              >
                <Link
                  to="/contact"
                  className="w-full sm:w-auto group relative inline-flex items-center justify-center gap-2 rounded-xl bg-brand text-white px-8 py-4 text-lg font-medium transition-all hover:bg-brand/90 hover:-translate-y-0.5 shadow-lg shadow-brand/20"
                >
                  Apply Now
              ...
              >
                {[
                  ...
                  <div key={idx}>
                    ...
                    <p className="text-xs font-semibold text-ink-soft uppercase tracking-wider">{stat.label}</p>
                  </div>
                ))}
              </motion.div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {[
              ...
              >
                ...
                <p className="text-xs uppercase tracking-widest font-semibold text-ink-soft mb-1">{item.label}</p>
