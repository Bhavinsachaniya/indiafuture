      ...
      <div className="container-x">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-6 text-ink-soft text-lg max-w-2xl mx-auto">
            Whether you're a student, an institution, or an organization, our programs are designed
            to help you learn, build, and implement AI in real-world settings.
          </p>
        </div>
            ...
            >
              <div className="flex items-start justify-between">
                <div className="grid h-12 w-12 place-items-center rounded-full bg-[#faf9f8] text-ink group-hover:bg-brand/10 transition-all duration-300">
                  <s.icon
                    className="h-5 w-5 group-hover:text-brand transition-colors duration-300"
                    strokeWidth={1.5}
                  />
                </div>
              ...
              <p className="mt-6 text-[10px] font-bold uppercase tracking-widest text-brand">
                {s.tag}
              </p>
