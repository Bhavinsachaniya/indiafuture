    ...
    <div className="hidden xl:block w-[320px] shrink-0 relative z-50">
      <div className="sticky top-32 bg-white border border-ink/10 rounded-3xl p-6 shadow-2xl shadow-ink/5">
        ...
        <div className="flex items-center justify-between mb-6 pb-6 border-b border-ink/10">
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-ink-soft mb-1">Status</p>
          ...
          <div className="text-right">
            <p className="text-xs font-semibold uppercase tracking-wider text-ink-soft mb-1">Seats</p>
        ...
        <div className="space-y-4 mb-8">
          {[
            ...
            <div key={idx} className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-ink-soft">{item.label}</p>
        ...
        <p className="text-xs text-center text-ink-soft leading-relaxed">
          Need corporate pricing? <Link to="/contact" className="text-brand hover:underline">Contact our sales team</Link>.
        </p>
      </div>
    </div>
  );
