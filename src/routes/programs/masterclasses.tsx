        ...
        <div className="container-x relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div>
              ...
              <p className="text-xs uppercase tracking-[0.2em] text-brand font-semibold mb-4">Masterclasses</p>
              
              <h1 className="font-display text-5xl md:text-6xl lg:text-[4.5rem] leading-[1.05] text-ink tracking-tight mb-8">
                Masterclasses & <br className="hidden md:block" />
                <span className="italic text-brand-soft">Certifications</span>
              </h1>
              
              <p className="text-ink-soft text-xl leading-relaxed mb-10 max-w-lg">
                Customized AI masterclasses for schools, colleges, working professionals, and MSMEs to use AI workflows immediately.
              </p>
            ...
            <div className="bg-white border border-ink/5 rounded-[32px] p-8 md:p-12 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.05)] relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col gap-6">
                  {[
                    "AI Workflows for Non-Technical Users",
                    "Enhancing Productivity with ChatGPT",
                    "Automating Spreadsheets with AI",
                    "Creating Visuals & Presentations Instantly",
                    "Certification & Assessment Projects"
                  ].map((item, idx) => (
